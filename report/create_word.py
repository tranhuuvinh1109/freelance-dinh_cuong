...
def create_report_docx(filename,save_dir, report):
    ...
    add_paragraph_with_style(doc, f'{report["sv_device"]}', 12, False, WD_PARAGRAPH_ALIGNMENT.LEFT)
    add_paragraph_with_style(doc, f'2. Cáp quang: {report["cable"]}', 12, False, WD_PARAGRAPH_ALIGNMENT.LEFT)
    add_paragraph_with_style(doc, f'{report["sv_cable"]}', 12, False, WD_PARAGRAPH_ALIGNMENT.LEFT)
    add_paragraph_with_style(doc, f'3. Nguồn điện, điều hoà: {report["power"]}', 12, False, WD_PARAGRAPH_ALIGNMENT.LEFT)
    add_paragraph_with_style(doc, f'{report["sv_power"]}', 12, False, WD_PARAGRAPH_ALIGNMENT.LEFT)
